...
/*参数多加了一个v，
  ...
  2014-12-14
 */
function showDialog(mode, msg, t, sd_width,fn,v) {
	...
	try {
		...
		var SD_html;
		SD_html = "";
		SD_html += "<table style='overflow-y:auto;' cellspacing='0' cellpadding='0'><tbody><tr><td class='SD_bg'></td><td class='SD_bg'></td><td class='SD_bg'></td></tr>";
		...
		$('#SD_cancel,#SD_close').click(function(){
			sd_remove();
		});
